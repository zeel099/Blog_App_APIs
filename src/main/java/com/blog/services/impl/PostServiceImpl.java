...
public class PostServiceImpl implements PostService{
	...
	@Override
	public PostResponse getAllPost(Integer pageNumber,Integer pageSize,String sortBy,String sortDir,String imageName) {
	...
	public List<PostDto> searchPosts(String keyword) {
		...
		List<PostDto> postDtos = posts.stream().map((post)->this.modelMapper.map(post,PostDto.class)).collect(Collectors.toList());  //lamdaAPI
		return  postDtos;
	}
